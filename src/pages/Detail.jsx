  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm overflow-hidden animate-fade-in-up">
        <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-cream">
        ...
        <form onSubmit={handleKirimWA} className="p-4 space-y-3">
          <div>
            <label className="block text-xs font-bold text-dark/70 uppercase tracking-wider mb-1.5">
              Nama Lengkap
            </label>
            <input
              type="text"
              ...
              required
              className="w-full p-2.5 bg-cream border border-gray-200 rounded-lg focus:ring-2 focus:ring-gold/20 focus:border-gold outline-none transition-all text-sm text-dark placeholder-gray-400"
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              required
              className="w-full p-2.5 bg-cream border border-gray-200 rounded-lg focus:ring-2 focus:ring-gold/20 focus:border-gold outline-none transition-all text-sm text-dark"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full py-3 bg-gold text-dark font-bold rounded-lg hover:bg-[#c5a575] transition-colors shadow-lg shadow-gold/20 flex items-center justify-center gap-2 text-sm"
          >
