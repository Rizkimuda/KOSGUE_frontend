    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-fade-in-up">
        <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-cream">
          <h3 className="text-xl font-serif font-bold text-dark">Jadwalkan Survei</h3>
        ...
        <form onSubmit={handleKirimWA} className="p-6 space-y-4">
          <div>
            <label className="block text-sm font-bold text-dark/70 uppercase tracking-wider mb-2">Nama Lengkap</label>
            <input 
              type="text" 
              name="nama" 
          ...
          <div>
            <label className="block text-sm font-bold text-dark/70 uppercase tracking-wider mb-2">Tanggal Survei</label>
            <input 
              type="date" 
              name="tanggalSurvei" 
              onChange={handleChange} 
          ...
          <div>
            <label className="block text-sm font-bold text-dark/70 uppercase tracking-wider mb-2">Waktu Survei</label>
            <input 
              type="time" 
              name="waktuSurvei" 
              onChange={handleChange} 
          ...
          <div>
            <label className="block text-sm font-bold text-dark/70 uppercase tracking-wider mb-2">Rencana Sewa</label>
            <select
              name="rencanaSewa"
              onChange={handleChange}
              className="w-full p-3 bg-cream border border-gray-200 rounded-xl focus:ring-2 focus:ring-gold/20 focus:border-gold outline-none transition-all text-dark"
          ...
          <div>
            <label className="block text-sm font-bold text-dark/70 uppercase tracking-wider mb-2">Catatan (Opsional)</label>
            <textarea 
              name="catatan" 
              onChange={handleChange} 
              rows="3"
